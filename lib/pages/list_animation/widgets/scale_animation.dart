...
class ScaleListAnimation extends StatelessWidget {
  const ScaleListAnimation({Key? key}) : super(key: key);
              ...
              child: Hero(
                ...
                child: AnimatedOpacity(
                  ...
                  child: Transform.scale(
                    /// Transform.scale config
                    scaleX: photo.getOpacityByElement(index, true),
                    scaleY: photo.getOpacityByElement(index, true),
